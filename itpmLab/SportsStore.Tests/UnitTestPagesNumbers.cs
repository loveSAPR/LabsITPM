...
namespace SportsStore.Tests {
    [TestClass]
    public class UnitTestPagesNumbers {
        [TestMethod]
        ...
        public void Can_Generate_Page_Links() {
            ...
            Func<int, string> pageUrlDeegate = i => "Page" + i;

            // Act
            MvcHtmlString result = myHelper.PageLinks(pagingInfo, pageUrlDeegate);
        ...
        public void Generate_Category_Specific_Product_Count() {
            ...
            int resAll = ((ProductsListViewModel)target
                .List("").Model).PagingInfo.TotalItems;
